    ...
    sections: [
      {
        ...
        steps: [
          ...
          'For GCash Test Mode, ServiceHub records RELEASED in its internal ledger. For cash, pay the agreed amount directly to the provider and ServiceHub records CASH_CONFIRMED.',
