...
export default function SeekerMessagesPage() {
  ...
  return (
    <div className={`rounded-[24px] p-8 border shadow-sm flex flex-col items-center justify-center text-center min-h-[350px] ${
      ...
      <div className="p-4 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-500 mb-5 shadow-inner">
        <MessageSquare className="w-10 h-10 animate-pulse" />
      </div>
      
      <span className="px-3 py-1 text-[10px] font-bold tracking-widest uppercase rounded-full border bg-orange-950/20 text-orange-400 border-orange-900/30">
