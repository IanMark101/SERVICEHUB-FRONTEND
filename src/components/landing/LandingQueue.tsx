  ...
  return (
    <section className="py-20 px-6 md:px-12 w-full relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <ScrollReveal className={`p-8 rounded-[24px] border backdrop-blur-xl shadow-lg relative overflow-hidden ${
          isDark
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 md:gap-4 relative">
            ...
            <div className="flex flex-col items-center text-center space-y-2.5 z-10 w-full md:w-1/4">
              <div className={`w-14 h-14 rounded-full flex items-center justify-center relative font-bold text-xs border-2 ${
                isDark ? 'bg-neutral-850 border-emerald-500 text-emerald-450' : 'bg-slate-50 border-emerald-500 text-emerald-700'
              }`}>
                Client A
            ...
            {/* Client B */}
            <div className="flex flex-col items-center text-center space-y-2.5 z-10 w-full md:w-1/4">
              <div className={`w-14 h-14 rounded-full flex items-center justify-center font-bold text-xs border ${
                isDark ? 'bg-[#2c2b27] border-neutral-855 text-neutral-400' : 'bg-slate-50 border-slate-200/60 text-slate-500'
              }`}>
                Client B
              </div>
              <div>
            ...
            {/* You */}
            <div className="flex flex-col items-center text-center space-y-2.5 z-10 w-full md:w-1/4">
              <div className={`w-14 h-14 rounded-full flex items-center justify-center font-bold text-xs border-2 shadow-sm ${
                isDark ? 'bg-neutral-850 border-orange-500 text-orange-400' : 'bg-orange-50 border-orange-500 text-orange-700'
              }`}>
                You
              </div>
              <div>
        ...
        {/* Callout Box */}
        <ScrollReveal className={`p-5 rounded-2xl border backdrop-blur-md flex items-start space-x-3.5 ${
          isDark ? 'bg-[#2c2b27]/60 border-neutral-855 text-amber-500/90' : 'bg-amber-50/60 border-amber-200/30 text-amber-900'
        }`}>
